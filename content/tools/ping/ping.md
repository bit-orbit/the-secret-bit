...
ابزار
ping
به صورت پیشفرض در هر ثانیه یک پکت
ICMP
به مقصد تعیین شده ارسال می‌‌کند،
بعد از ارسال هر پکت،
این ابزار جمع زمان ارسال و دریافت جواب را باز می‌گرداند.
</div>
...
به 8.8.8.8
(Google DNS server)
ارسال می شود و خروجی آن نشان دهنده اتصال ما به اینترنت و در دسترس بودن
DNS
گوگل هست.
</div>
...
- (TTL/Time To Live) 
به معنی مدت زمانی که یک بسته ی اطلاعاتی می توانید در شبکه باقی بماند و با 
`ttl=[1/255]`
...
## ارسال پکت برای مدت زمان مشخص
مدت زمان محدود برای ارسال درخواست را با سوییچ
`w-`
تعیین می کنیم.  
...
## نمایش مختصر نتیجه
برای نمایش خلاصه خروجی از سوییچ
`q-`
استفاده می کنیم.
</div>
‍‍
...
برای نمایش تایم استمپ در خروجی از سوییچ
`D-`
استفاده می کنیم.
</div>
